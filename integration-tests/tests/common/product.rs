...
pub enum RegisterProductCommand {
...
impl RegisterProductCommand {
    pub fn all() -> [Self; 11] {
        [
            ...
            Self::Locked10Minutes20000ScoreCap,
        ]
    }
}
    ...
    fn json(&self) -> Value {
        match self {
            RegisterProductCommand::Locked12Months12Percents => json!({
                ...
                "terms": {
                    "type": "fixed",
                    "data": { "lockup_term": "31556952000", "apy": { "default": ["12", 2] } }
                },
                "is_enabled": true,
                "is_restakable": true,
            }),
            RegisterProductCommand::Locked6Months6Percents => json!({
                ...
                "terms": {
                    "type": "fixed",
                    "data": { "lockup_term": "15778476000", "apy": { "default": ["6", 2] } }
                },
                "is_enabled": true,
                "is_restakable": true,
            }),
            RegisterProductCommand::Flexible6Months6Percents => json!({
                ...
                "terms": {
                    "type": "flexible",
                    "data": { "apy": { "default": ["12", 2], "fallback": ["6", 2] } },
                },
                "is_enabled": true,
                "is_restakable": true,
            }),
            RegisterProductCommand::Locked6Months6PercentsWithWithdrawFee => json!({
                ...
                "withdrawal_fee": { "type": "fix", "data": "1000" },
                "is_enabled": true,
                "is_restakable": true,
            }),
            RegisterProductCommand::Locked10Minutes6Percents => json!({
                ...
                "terms": {
                    "type": "fixed",
                    "data": { "lockup_term": "600000", "apy": { "default": ["6", 2] } }
                },
                "is_enabled": true,
                "is_restakable": true,
            }),
            RegisterProductCommand::Locked5Minutes60000Percents => json!({
                ...
                "terms": {
                    "type": "fixed",
                    "data": { "lockup_term": "300000", "apy": { "default": ["60000", 2] } }
                },
                "is_enabled": true,
                "is_restakable": true,
            }),
            RegisterProductCommand::Locked10Minutes60000Percents => json!({
                ...
                "terms": {
                    "type": "fixed",
                    "data": { "lockup_term": "600000", "apy": { "default": ["60000", 2] } }
                },
                "is_enabled": true,
                "is_restakable": true,
            }),
            ...
            RegisterProductCommand::Locked10Minutes6PercentsWithPercentWithdrawFee => json!({
                ...
                "withdrawal_fee": { "type": "percent", "data": ["1", 2] },
                "is_enabled": true,
                "is_restakable": true,
            }),
            RegisterProductCommand::Locked10Minutes20000ScoreCap => json!({
                ...
                "terms": {
                    "type": "score_based",
                    "data": { "lockup_term": "600000", "score_cap": 20000 }
                },
                "is_enabled": true,
                "is_restakable": true,
            }),
